...
if __name__ == '__main__':
    ...
    # GET THE AGENT
    ###########################
##to be changed potentially back again to learningAgents!!!!!!!!!!!!!!
    ...
    if opts.agent == 'value':
        ...
        qLearnOpts = {'gamma': opts.discount,
                      ...
                      'actionFn': actionFn}
        a = learningAgents.LearnedQAgent(gridWorldEnv.gridWorld, **qLearnOpts)
    elif opts.agent == 'q':
        ...
        qLearnOpts = {'gamma': opts.discount,
                      ...
                      'epsilon': opts.epsilon,
                      'actionFn': actionFn}
        a = learningAgents.QLearningAgent(**qLearnOpts)
